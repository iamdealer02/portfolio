...
const Links = () => {
  return (
    <div className=' relative md:fixed max-xl:fixed  links p-5 ml-5  border rounded-md border-solid border-white-100 flex flex-col justify-start items-end self-end w-fit'>
