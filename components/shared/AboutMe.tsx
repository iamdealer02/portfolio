...
const AboutMe = () => {
  return (
    <div id='aboutMe'  className=' p-28 mt-40 mb-16 mx-auto '>
      ...
      <div className='flex flex-col mx-auto mt-10 max-w-3xl'>
        <div className='flex flex-col space-y-11'>
          <div className='bg-blue-300 rounded-md text-black w-80 p-3 self-start'>
          ...
          <div className='bg-blue-300 rounded-md text-black w-80 p-3 self-end'>
